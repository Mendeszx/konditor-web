/**
 * Konditor — Tailwind CSS build configuration.
 * Fonte única dos design tokens (antes em assets/js/konditor-config.js via CDN).
 *
 * Build: ./scripts/build-css.sh  →  gera assets/css/tailwind.css
 */
module.exports = {
